...
public class LicenciaController implements ActionListener, KeyListener, MouseListener {
    ...
    private void interfaces() {
        ...
        frmMenu.btnActualizarLicencia.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        //  Evento ActionPerformed para el boton registrarPerfilLaboral
        ...
        // Evento ActionListener para el boton Actualizar Licencia
        if (e.getSource().equals(frmMenu.btnActualizarLicencia)) {
            int codLicencia = Integer.parseInt(frmMenu.txtCodLicencia.getText());
            String numLicencia = frmMenu.txtNumLicencia.getText();
            String categoria = frmMenu.cboCategoriaLicencia.getSelectedItem().toString();
            Date fechaEmision = Date.valueOf(frmMenu.txtFechaEmsion.getText());//primero
            Date fechaCaducidad = Date.valueOf(frmMenu.txtFechaCaducidad.getText());
            int idTrabajador = Integer.parseInt(frmMenu.txtIdTrabajadorLicencia.getText());
            lic = new Licencia(codLicencia, numLicencia, categoria, fechaEmision, fechaCaducidad, idTrabajador);
            if (licDAO.actualizarLicencia(lic)) {
                limpiarInputs();
                cargarTabla();
                JOptionPane.showMessageDialog(frmMenu, "Licencia actualizada");
                enableButtons();
            } else {
                JOptionPane.showMessageDialog(frmMenu, "No se pudo actulizar licencia");
            }
        }
