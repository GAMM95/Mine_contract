...
public class ValeController implements ActionListener, MouseListener, KeyListener {
    ...
    private void cargarTabla() {
        ...
        frmMenu.tblVale.getTableHeader().setFont(new Font("Roboto", Font.BOLD, 14));
        frmMenu.tblVale.getTableHeader().setOpaque(false);
        frmMenu.tblVale.getTableHeader().setBackground(Color.decode("#10316B"));
        frmMenu.tblVale.getTableHeader().setForeground(Color.decode("#FFFFFF"));
