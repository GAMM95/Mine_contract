...
public class DSelectorTrabajadorGuardia extends javax.swing.JDialog {
    ...
    public DSelectorTrabajadorGuardia() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DSelectorTrabajadorGuardia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            DSelectorTrabajadorGuardia dialog = new DSelectorTrabajadorGuardia();
